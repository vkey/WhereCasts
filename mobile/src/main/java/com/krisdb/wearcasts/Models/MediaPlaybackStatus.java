...
public class MediaPlaybackStatus {
    ...
    private boolean media_play, media_start, media_paused, media_error, media_completed, media_playlist_skip, media_playing, media_synced;
    ...
    public boolean getMediaSync() {
        return media_synced;
    }

    public void setMediaSync(final boolean synced) {
        this.media_synced = synced;
    }
